...
CREATE TABLE IF NOT EXISTS nodes (id TEXT PRIMARY KEY, name TEXT, host TEXT, port INTEGER DEFAULT 22, api_port INTEGER DEFAULT 8000, api_token TEXT, country TEXT, protocols TEXT DEFAULT '["vless","hysteria2"]', status TEXT DEFAULT 'offline', traffic_used INTEGER DEFAULT 0, created_at INTEGER, ssh_user TEXT DEFAULT 'root', ssh_password TEXT DEFAULT '', public_key TEXT DEFAULT '', short_id TEXT DEFAULT '', panel_port INTEGER DEFAULT 8080, ssh_pass TEXT DEFAULT '', uuid TEXT DEFAULT '');
